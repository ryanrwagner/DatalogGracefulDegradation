...
#NEWCOMMENTremoteUserExploit(TargetService,1) <= isAccount(TargetService,'userAccount') & ~remoteUserExploit(TargetService,C)
#NEWCOMMENTlocalRootExploit(TargetService,1) <= isAccount(TargetService,'userAccount') & ~localRootExploit(TargetService,C)
#NEWCOMMENTremoteRootExploit(TargetService,1) <= isAccount(TargetService,'superUserAccount') & residesOn(IntermediateService1,TargetService) & ~remoteRootExploit(TargetService,C)
...
#NEWCOMMENTremoteRootExploitWithAttributes(TargetService,1,True,False,False) <= isAccount(TargetService,'superUserAccount') & residesOn(IntermediateService1,TargetService)
#NEWCOMMENTremoteRootExploitWithAttributes(TargetService,1,False,True,False) <= isAccount(TargetService,'superUserAccount') & residesOn(IntermediateService1,TargetService)
#NEWCOMMENTremoteRootExploitWithAttributes(TargetService,1,False,False,True) <= isAccount(TargetService,'superUserAccount') & residesOn(IntermediateService1,TargetService)
